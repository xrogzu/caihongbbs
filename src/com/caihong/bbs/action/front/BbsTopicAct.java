...
import static com.caihong.bbs.Constants.TPLDIR_FORUM;
import static com.caihong.bbs.Constants.TPLDIR_TOPIC;
import static com.caihong.bbs.entity.BbsTopic.TOPIC_NORMAL;
...
import com.caihong.bbs.cache.TopicCountEhCache;
...
import com.caihong.bbs.manager.BbsCategoryMng;
...
public class BbsTopicAct {
	...
	public String save(Integer forumId, Integer postTypeId, String title,
			String content, Integer category, Integer categoryType,String[] name,
		...
		BbsTopic bean = manager.postTopic(user.getId(), site.getId(), forumId,
				postTypeId, title, content, ip, category, categoryType,name,files, code);
