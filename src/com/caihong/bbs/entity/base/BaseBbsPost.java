...
public abstract class BaseBbsPost  implements Serializable {
	...
	public BaseBbsPost (
		...
		com.caihong.bbs.entity.BbsConfig config,
		com.caihong.bbs.entity.BbsTopic topic,
		com.caihong.bbs.entity.BbsUser creater,
	...
	// one to one
	private com.caihong.bbs.entity.BbsPostText postText;

	// many to one
	private com.caihong.core.entity.CmsSite site;
	private com.caihong.bbs.entity.BbsConfig config;
	private com.caihong.bbs.entity.BbsTopic topic;
	private com.caihong.bbs.entity.BbsUser creater;
	private com.caihong.bbs.entity.BbsUser editer;
	private com.caihong.bbs.entity.BbsPostType postType;

	// collections
	private java.util.Set<com.caihong.bbs.entity.BbsGrade> grade;
	private java.util.Set<com.caihong.bbs.entity.Attachment> attachments;
	 ...
	 */
	public com.caihong.bbs.entity.BbsPostText getPostText () {
		return postText;
	}
	 ...
	 */
	public void setPostText (com.caihong.bbs.entity.BbsPostText postText) {
	 ...
	 */
	public com.caihong.bbs.entity.BbsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.caihong.bbs.entity.BbsConfig config) {
		this.config = config;
	}
	 ...
	 */
	public com.caihong.bbs.entity.BbsTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.caihong.bbs.entity.BbsTopic topic) {
		this.topic = topic;
	}
	 ...
	 */
	public com.caihong.bbs.entity.BbsUser getCreater () {
		return creater;
	}
	 ...
	 */
	public void setCreater (com.caihong.bbs.entity.BbsUser creater) {
	 ...
	 */
	public com.caihong.bbs.entity.BbsUser getEditer () {
		return editer;
	}
	 ...
	 */
	public void setEditer (com.caihong.bbs.entity.BbsUser editer) {
		this.editer = editer;
	}

	public com.caihong.bbs.entity.BbsPostType getPostType() {
		return postType;
	}

	public void setPostType(com.caihong.bbs.entity.BbsPostType postType) {
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsGrade> getGrade () {
		return grade;
	}
	 ...
	 */
	public void setGrade (java.util.Set<com.caihong.bbs.entity.BbsGrade> grade) {
		this.grade = grade;
	}
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.Attachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.Set<com.caihong.bbs.entity.Attachment> attachments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.bbs.entity.BbsPost)) return false;
		else {
			com.caihong.bbs.entity.BbsPost bbsPost = (com.caihong.bbs.entity.BbsPost) obj;
