...
public abstract class BaseBbsCommonMagic  implements Serializable {
	...
	// collections
	private java.util.Set<com.caihong.bbs.entity.BbsUser> users;
	private java.util.Set<com.caihong.bbs.entity.BbsUserGroup> useGroups;
	private java.util.Set<com.caihong.bbs.entity.BbsUserGroup> toUseGroups;
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.caihong.bbs.entity.BbsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsUserGroup> getUseGroups () {
		return useGroups;
	}
	 ...
	 */
	public void setUseGroups (java.util.Set<com.caihong.bbs.entity.BbsUserGroup> useGroups) {
		this.useGroups = useGroups;
	}
	
	public java.util.Set<com.caihong.bbs.entity.BbsUserGroup> getToUseGroups() {
		return toUseGroups;
	}

	public void setToUseGroups(
			java.util.Set<com.caihong.bbs.entity.BbsUserGroup> toUseGroups) {
		this.toUseGroups = toUseGroups;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.caihong.bbs.entity.BbsCommonMagic)) return false;
		else {
			com.caihong.bbs.entity.BbsCommonMagic bbsCommonMagic = (com.caihong.bbs.entity.BbsCommonMagic) obj;
