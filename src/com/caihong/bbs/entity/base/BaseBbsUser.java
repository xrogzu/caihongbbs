...
public abstract class BaseBbsUser implements Serializable {
	 ...
	 */
	public BaseBbsUser(java.lang.Integer id,
			com.caihong.bbs.entity.BbsUserGroup group,
	...
	// one to one
	private com.caihong.bbs.entity.BbsUserOnline userOnline;

	// many to one
	private com.caihong.bbs.entity.BbsUserGroup group;
	
	private com.caihong.bbs.entity.BbsUserActiveLevel activeLevel;

	// collections
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.caihong.bbs.entity.BbsUserExt> userExtSet;
	private java.util.Set<com.caihong.bbs.entity.BbsLoginLog> loginLogs;
	private java.util.Set<com.caihong.bbs.entity.BbsMemberMagic> memberMagics;
	
	private java.util.Set<com.caihong.bbs.entity.BbsOperation> operations;
	private java.util.Set<com.caihong.bbs.entity.BbsSession> sessions;
	private java.util.Set<com.caihong.bbs.entity.BbsFriendShip> myFriends;
	private java.util.Set<com.caihong.bbs.entity.BbsFriendShip> toFriends;
	...
	public com.caihong.bbs.entity.BbsUserOnline getUserOnline() {
		return userOnline;
	}

	public void setUserOnline(com.caihong.bbs.entity.BbsUserOnline userOnline) {
	 ...
	 */
	public com.caihong.bbs.entity.BbsUserGroup getGroup() {
		return group;
	}
	 ...
	 *            the group_id value
	 */
	public void setGroup(com.caihong.bbs.entity.BbsUserGroup group) {
		this.group = group;
	}
	
	public com.caihong.bbs.entity.BbsUserActiveLevel getActiveLevel() {
		return activeLevel;
	}

	public void setActiveLevel(com.caihong.bbs.entity.BbsUserActiveLevel activeLevel) {
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsUserExt> getUserExtSet() {
		return userExtSet;
	}
	...
	public void setUserExtSet(
			java.util.Set<com.caihong.bbs.entity.BbsUserExt> userExtSet) {
		this.userExtSet = userExtSet;
	}

	public java.util.Set<com.caihong.bbs.entity.BbsLoginLog> getLoginLogs() {
		return loginLogs;
	}

	public void setLoginLogs(
			java.util.Set<com.caihong.bbs.entity.BbsLoginLog> loginLogs) {
		this.loginLogs = loginLogs;
	}

	

	public java.util.Set<com.caihong.bbs.entity.BbsMemberMagic> getMemberMagics() {
		return memberMagics;
	}

	public void setMemberMagics(
			java.util.Set<com.caihong.bbs.entity.BbsMemberMagic> memberMagics) {
		this.memberMagics = memberMagics;
	}
	
	public java.util.Set<com.caihong.bbs.entity.BbsOperation> getOperations() {
		return operations;
	}

	public void setOperations(
			java.util.Set<com.caihong.bbs.entity.BbsOperation> operations) {
		this.operations = operations;
	}

	public java.util.Set<com.caihong.bbs.entity.BbsSession> getSessions() {
		return sessions;
	}

	public void setSessions(java.util.Set<com.caihong.bbs.entity.BbsSession> sessions) {
		this.sessions = sessions;
	}
	
	public java.util.Set<com.caihong.bbs.entity.BbsFriendShip> getMyFriends() {
		return myFriends;
	}

	public void setMyFriends(
			java.util.Set<com.caihong.bbs.entity.BbsFriendShip> myFriends) {
		this.myFriends = myFriends;
	}

	public java.util.Set<com.caihong.bbs.entity.BbsFriendShip> getToFriends() {
		return toFriends;
	}

	public void setToFriends(
			java.util.Set<com.caihong.bbs.entity.BbsFriendShip> toFriends) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.caihong.bbs.entity.BbsUser))
			return false;
		else {
			com.caihong.bbs.entity.BbsUser bbsUser = (com.caihong.bbs.entity.BbsUser) obj;
