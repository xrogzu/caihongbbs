...
public abstract class BaseBbsReportExt  implements Serializable {
	...
	// many to one
	private com.caihong.bbs.entity.BbsUser reportUser;
	private com.caihong.bbs.entity.BbsReport report;
	 ...
	 */
	public com.caihong.bbs.entity.BbsUser getReportUser () {
		return reportUser;
	}
	 ...
	 */
	public void setReportUser (com.caihong.bbs.entity.BbsUser reportUser) {
	 ...
	 */
	public com.caihong.bbs.entity.BbsReport getReport () {
		return report;
	}
	 ...
	 */
	public void setReport (com.caihong.bbs.entity.BbsReport report) {
		this.report = report;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.bbs.entity.BbsReportExt)) return false;
		else {
			com.caihong.bbs.entity.BbsReportExt bbsReportExt = (com.caihong.bbs.entity.BbsReportExt) obj;
