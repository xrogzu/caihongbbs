...
public abstract class BaseBbsOperation  implements Serializable {
	...
	private com.caihong.bbs.entity.BbsUser operater;
	private com.caihong.bbs.entity.BbsPost post;
	 ...
	 */
	public com.caihong.bbs.entity.BbsUser getOperater () {
		return operater;
	}
	 ...
	 */
	public void setOperater (com.caihong.bbs.entity.BbsUser operater) {
	 ...
	 */
	public com.caihong.bbs.entity.BbsPost getPost () {
		return post;
	}
	 ...
	 */
	public void setPost (com.caihong.bbs.entity.BbsPost post) {
		this.post = post;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.bbs.entity.BbsOperation)) return false;
		else {
			com.caihong.bbs.entity.BbsOperation bbsOperation = (com.caihong.bbs.entity.BbsOperation) obj;
