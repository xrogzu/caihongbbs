...
public abstract class BaseBbsCreditExchange  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.bbs.entity.BbsCreditExchange)) return false;
		else {
			com.caihong.bbs.entity.BbsCreditExchange bbsCreditExchange = (com.caihong.bbs.entity.BbsCreditExchange) obj;
