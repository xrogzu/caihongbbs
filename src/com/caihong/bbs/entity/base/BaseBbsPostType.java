...
public abstract class BaseBbsPostType  implements Serializable {
	...
	private com.caihong.bbs.entity.BbsPostType parent;

	// collections
	private java.util.Set<com.caihong.bbs.entity.BbsPostType> childs;
	private java.util.Set<com.caihong.bbs.entity.BbsUserGroup> groups;
	 ...
	 */
	public com.caihong.bbs.entity.BbsPostType getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.caihong.bbs.entity.BbsPostType parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsPostType> getChilds () {
		return childs;
	}
	 ...
	 */
	public void setChilds (java.util.Set<com.caihong.bbs.entity.BbsPostType> childs) {
		this.childs = childs;
	}
	 ...
	 */
	public java.util.Set<com.caihong.bbs.entity.BbsUserGroup> getGroups () {
		return groups;
	}
	 ...
	 */
	public void setGroups (java.util.Set<com.caihong.bbs.entity.BbsUserGroup> groups) {
		this.groups = groups;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.bbs.entity.BbsPostType)) return false;
		else {
			com.caihong.bbs.entity.BbsPostType bbsPostType = (com.caihong.bbs.entity.BbsPostType) obj;
