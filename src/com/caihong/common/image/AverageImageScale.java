package com.caihong.common.image;
...
import com.caihong.common.image.ImageUtils.Position;
...
public class AverageImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		AverageImageScale.resizeFix(new File(
				"test/com/caihong/common/util/1.bmp"), new File(
				"test/com/caihong/common/util/1-n-2.bmp"), 310, 310, 50, 50,
				320, 320);
