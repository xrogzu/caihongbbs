...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.caihong.core.entity.MarkConfig m_markConfig;
	...
	public com.caihong.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.caihong.core.entity.MarkConfig m_markConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.core.entity.CmsConfig)) return false;
		else {
			com.caihong.core.entity.CmsConfig cmsConfig = (com.caihong.core.entity.CmsConfig) obj;
